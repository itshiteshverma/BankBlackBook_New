...
public class CustomAutoCompleteTextChangedListener_Nominee implements TextWatcher {
    ...
    public void onTextChanged(CharSequence userInput, int start, int before, int count) {
        ...
        // update the adapater
        mainActivity.myAdapter_Nominee.notifyDataSetChanged();
        mainActivity.myAdapter_Nominee = new ArrayAdapter<String>(mainActivity, android.R.layout.simple_dropdown_item_1line, mainActivity.item);
        mainActivity.Nominee.setAdapter(mainActivity.myAdapter_Nominee);
